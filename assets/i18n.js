...
(function () {
  var EN = {
    ...
    "ck.body": "We use cookies so the site works and we know what you like. Details in our <a href=\"cookies.html\" style=\"color:#fef7e5;font-weight:700\">cookie policy</a>.",
    "ck.necessary": "Essential only",
    "ck.all": "Accept all",
    "promo.kicker": "Deal · Lunch menu",
    "promo.title": "Free soup with your lunch!",
    "promo.body": "Every day from <strong>10 am to 2 pm</strong>, get a free soup with selected dishes.",
    "promo.visit": "I'll stop by",
    "akce.d5": "Bun Cha La Lot",
    "akce.d6": "Thit Kho Tau with pork",
    "akce.d7": "Thit Kho Tau with chicken",
    "promo.d1": "Fried rice",
    "promo.d2": "Rice noodles",
    "promo.d3": "Noodles",
    "promo.d4": "Pork neck in sweet and sour sauce",
    "promo.d5": "Bun Cha La Lot",
    "promo.d6": "Thit Kho Tau with pork",
    "promo.d7": "Thit Kho Tau with chicken",
    "review.title": "Enjoyed it?<br><span style=\"color:#873924\">Let others<br>know too!</span>",
    "review.btn": "Write a Google review",
    ...
    "pp.t1b": "The site itself collects no personal data. We only store technical settings (language, cookie choice) — more in our <a href=\"cookies.html\">cookie policy</a>.",
